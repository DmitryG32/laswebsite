...
(0,_components_swiper_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
const progressAnimation = () => {
  ...
  circle.setAttribute(
    "stroke-dashoffset",
    circleLenght - (circleLenght * percentageProgress) / 100
  );
};

progressAnimation(); */
const circle = document.querySelectorAll(".facts__item-circle");
circle.forEach(el => {
  if (el.dataset.percentage == "true") {
    let progress = el.querySelector(".progress");
    let valueBlock = el.querySelector(".facts__item-value");
...
const swiper = () => {
  ...
  !function (e, t) {
    ...
    function L(e) {
      ...
      const g = l.noSwipingSelector ? l.noSwipingSelector : ".".concat(l.noSwipingClass),
